...
"}")
        ...
        sizePolicy.setHeightForWidth(self.side_main.sizePolicy().hasHeightForWidth())
        self.side_main.setSizePolicy(sizePolicy)
        self.side_main.setMinimumSize(QSize(100, 200))
        self.side_main.setStyleSheet(u"QToolButton{\n"
"border:none;\n"
...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.join_btn.sizePolicy().hasHeightForWidth())
        self.join_btn.setSizePolicy(sizePolicy1)
        ...
        self.horizontalLayout_2.addWidget(self.side_main, 0, Qt.AlignLeft|Qt.AlignTop)
        ...
        sizePolicy2.setHeightForWidth(self.join_frame.sizePolicy().hasHeightForWidth())
        self.join_frame.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.port_id.sizePolicy().hasHeightForWidth())
        self.port_id.setSizePolicy(sizePolicy3)
        self.port_id.setMinimumSize(QSize(0, 0))
        font2 = QFont()
        font2.setPointSize(13)
        self.port_id.setFont(font2)
        ...
        sizePolicy3.setHeightForWidth(self.host_id.sizePolicy().hasHeightForWidth())
        self.host_id.setSizePolicy(sizePolicy3)
        self.host_id.setMinimumSize(QSize(0, 0))
        self.host_id.setFont(font2)
...
"")
        ...
        sizePolicy4.setHeightForWidth(self.hst_prt.sizePolicy().hasHeightForWidth())
        self.hst_prt.setSizePolicy(sizePolicy4)
...
"")
        ...
        self.message_area.setGeometry(QRect(0, 0, 590, 318))
        sizePolicy2.setHeightForWidth(self.message_area.sizePolicy().hasHeightForWidth())
        self.message_area.setSizePolicy(sizePolicy2)
...
"border:0")
        ...
        self.horizontalLayout_5.addWidget(self.recv_mess_area)
...
"border:0")
        ...
        self.send_mess_area.raise_()
        self.recv_mess_area.raise_()
